...
void flood_fill(struct maze *maze, int x, int y, int destX, int destY)   // Flood fill algorithm with destination in the center of the maze
{
  ...
  while (top >= 0)
  {
    ...
    if (currentX + 1 < MAZE_SIZE && maze->cells[currentX][currentY].right == 0)
    {
    ...
    else if (currentX - 1 >= 0  && !maze->cells[currentX][currentY].left == 0)
    {
      stack[++top].x = currentX - 1;
      stack[top].y = currentY;
      maze->cells[currentX - 1][currentY].visited = true;
    ...
    else if (currentY + 1 < MAZE_SIZE  && !maze->cells[currentX][currentY].centre == 0)
    {
    ...
    else if (currentY - 1 >= 0  && !maze->cells[currentX][currentY].centre == 0 && !maze->cells[currentX][currentY].left == 0 && !maze->cells[currentX][currentY].left == 0)
    {
      stack[++top].x = currentX;
      stack[top].y = currentY - 1;
      maze->cells[currentX][currentY - 1].visited = true;
