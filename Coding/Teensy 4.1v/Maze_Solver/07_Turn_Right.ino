////////////////////////////////////////////////////////////////////////////////////////////////////////
void Turn_Right(int targetDistanceLeft = RightrotationTargetDistanceLeft, int targetDistanceRight = RightrotationTargetDistanceRight)
{
  ...
  while (!Both_Done)
  {
    if ((encoderPosLeft < (targetDistanceLeft + 5) and encoderPosLeft > (targetDistanceLeft - 5)) and Left_Done != true)
    {
