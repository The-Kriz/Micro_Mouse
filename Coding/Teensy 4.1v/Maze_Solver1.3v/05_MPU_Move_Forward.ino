...
//    bt.print("angle:");
//    bt.println(z);
//    int motorSpeed_MPU = abs(PID_MPU.compute(z));
...
//      {
//        if (z < 0 and encoderPosLeft < (targetDistanceLeft - 15))
//        {
...
//      {
//        if (z > 0  and encoderPosRight < (targetDistanceRight - 15))
//        {
//          motorSpeedRight =  motorSpeedRight + abs(motorSpeed_MPU);
//        }
